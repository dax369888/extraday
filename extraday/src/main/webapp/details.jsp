		...
		<script type="text/javascript">
			...
			$(function(){						
				$(".sec_img ul li").click(function(){
    				...
    				$(".sec_1 img").attr("src","img/details/"+imgs[index]);			
	...
	<body>
		<header>
				...
				<div class="h_head">
					<span>送至：南京</span>
						<div class="h_top_r fr">	
							<ul>
								<li><span class="h_1">请   </span><a href="#" class="active">登陆</a></li>
								<li><a href="#">免费注册</a></li>
								<li><a href="#">我的订单</a></li>
                                <li class="coll_bg">
									<a href="#">我的特卖</a>
			...
			<div class="h_bottom">
				<div class="h_bottom1 ">
					<div class="logo">
						<span>星期八  </span> My Day
					</div>
					<div class="search fr">
						<form>
							<input type="search" placeholder="请输入心仪宝贝" />
		...
		<section>
			<div class="sec_s">
				<div class="sec_s_left fl">
					<div class="sec_1 ">
						<img src="img/details/E_13.jpg" alt="复古温柔风连衣裙" />
					</div>
					<div class="sec_img">
						<ul>
							<li class="active"><img  src="img/details/E_13.jpg" /></li>
							<li><img src="img/details/E_13_1.jpg" /></li>
							<li><img src="img/details/E_13_2.jpg" /></li>
							<li><img src="img/details/E_13_3.jpg" /></li>
							<li><img src="img/details/E_13_4.jpg" /></li>
						</ul>
					</div>
				
					<div class="sec_coll">
						<dl>
							<dt><a href="#"><img src="img/details/E_s.png"/>收藏宝贝</a>(181...人气)</dt>

						</dl>
						<dl>
							<dt><a><img src="img/details/E_f.png"/>分享</a></dt>
							<dd class="fr"></dd>
						</dl>
					</div>
				</div>
				<div class="sec_s_right fl">
					<p>复古温柔风连衣裙 碎花雪纺初恋裙少女夏季新款 </p>
					<div class="sec_price ">
						<div class="sec_p1 fl ">
							<ul>
								<li>价格<span class="sec_number1">￥149</span></li>
								<li>星期八价<span class="sec_number2">￥128</span></li>
							</ul>
						</div>
						<div class="sec_p2 fr">
							<ul>
					...
					<div class="sec_select">
						<dl>
							<dd>
								<div class="sec_send">
									<span>配送</span>
									<ul>
										<li class="sec_send_place">
											<span class="sec_beg">浙江杭州</span> 至 
											<span class="sec_des">南京</span>
										</li>
										<li class="sec_send_del">
											<span>快递 免运费</span>
										</li>
										<li class="sec_send_deli">
											<span>24小时内发货</span>
										</li>
									</ul>
								</div>
							...
							<dd>数量
									<div class="sec_num fr">
										<button class="DelCount ">-</button>
										<input class="inputCount " title="请输入购买量" type="text " value="1 " />
										<button class="AddCount ">+</button>件
									</div>
							</dd>								
						</dl>
					</div>
						<div class="sec_buy">
							...
							<a href="#" id="car">加入购物车</a>
						</div>
						<div class="sec_extra">
							<dl>
								<dt>承诺</dt>
								<dd>
									<a href="#"  title="满足7天无理由退换货申请的前提下，包邮商品需要买家承担退货邮费，
										非包邮商品需要买家承担发货和退货邮费"><img src="img/details/E_sd.jpg"/>
										7天无理由</a>
								</dd>
							</dl>
							<dl>
								...
								<a href="#" title=""><img src="img/details/E_mayi.png"/>
									蚂蚁花呗</a>
								<a href="#" ><img src="img/details/E_yu.png"/>余额</a>
								</dd>
							</dl>
						</div>
				</div>				
			...
			<div class="sec_all">
				...
				<div class="sec_detail_img">
					...
					<img src="img/details/E_det4.png" style="width: 780px;height: 1100px;"/>
					<p class="sec_heading">星期八效果图</p>
					<img src="img/details/E_det2.png" style="width: 800px;"/>
					<p class="sec_heading">星期八模特展示</p>
					<img src="img/details/E_det5.png" style="width: 800px;height: 1200px;" />
					<p class="sec_words">和飘逸的长裙相比，短裙更显精灵俏皮哦</p>
					<p class="sec_words">系带的镂空领，轻松演绎复古文艺。</p>
					<img src="img/details/E_det6.jpg" style="width: 800px;height: 1200px;"/>
					<p class="sec_words">浪漫的荷叶摆，短裙也爱飘逸!</p>
					<p class="sec_words">腰线自然不能少，</p>	
					<p class="sec_words">小个子姑娘显高的秘诀在这里哦！</p>	
					<img src="img/details/E_det7.jpg" style="width: 800px;height: 1000px;"/>
					<p class="sec_words">颜色是低调又明艳的那种，</p>
					<p class="sec_words">米色打底，大部分姑娘都适合，</p>	
					<p class="sec_words">气质还不怎么挑人。</p>
					<img src="img/details/E_det8.jpg" />
					<img src="img/details/E_det9.jpg" />
					<img src="img/details/E_det10.jpg" />
					<img src="img/details/E_det11.jpg" />
					<img src="img/details/E_det12.jpg" />
					<img src="img/details/E_det13.jpg" />
					<img src="img/details/E_det14.jpg" />
					<img src="img/details/E_det15.jpg" />
					<img src="img/details/E_det16.jpg" />
					<img src="img/details/E_det17.jpg" />
					<img src="img/details/E_det18.jpg" />
					<img src="img/details/E_det19.jpg" />
					<p class="sec_heading">细节展示</p>
					<img src="img/details/E_det20.png" style="width: 800px;"/>
					<img src="img/details/E_det21.png" style="width: 800px;"/>
					<img src="img/details/E_det22.png" style="width: 800px;"/>
					<img src="img/details/E_det23.jpg" style="width: 800px;" />
					<img src="img/details/E_det24.png" style="width: 800px;"/>
					<img src="img/details/E_det25.png" style="width: 800px;"/>
				</div>
				<!--评论-->
				<div class="sec_comment">
					...
					<div class="sec_bar">
						<ul class="secBar_bars">
							<li>
								<label>
									<input value="" checked="" type="radio" />全部 
								</label>
							</li>
							<li>
								<label>
									<input value="3"  type="radio" />图片
									<span>
										<span>(751)</span>
									</span>
								</label>
						...
						<div class="sec_main">
							<ul>
								<li class="sec_main_first">
									...
									<div class="review-details">
										<div class="review-content">
											  买给妹妹去乌镇旅游穿的，很好看的啦，
											  只吃梅子家，我妹一米六，九十五斤emmmm.							
										</div>
										<div class="review-media">
											<ul>
												<li>
													<img mp4-src="//cloud.video.taobao.com/play/u/77794e4b5664726a444e4344414e6c2f5479507732413d3d/p/1/d/ud/e/6/t/1/50169954804.mp4" 
												...
												<li>
													<img src="img/details/item_1.jpg" />
												</li>
												<li>
													<img src="img/details/item_2.jpg" />
												</li>
												<li>
													<img src="img/details/item_3.jpg" />
												</li>
												<li>
													<img src="img/details/item_4.jpg" />
												</li>
											</ul>
										</div>
										<div class="review-bar">
											...
											<ul class="review-bar-actions">
												<li class="review-bar-action">
													<span class="review-bar-btn">有用</span>
													<span class="review-bar-num">(0)</span>
												</li>
											</ul>
										</div>
									</div>
								...
								<li class="sec_main_first">
									...
									<div class="review-details">
										<div class="review-content">
											  这是一个好评模板，因为本仙女很懒，不想每个产品都写好评，
											  所以特地模仿一位网友写下了这个模板，但是这个产品无论是质
											  量和外观肯定都是仙女喜欢的，如果不喜欢仙女收到东西会很生气，
											  然后这个模板就会变成仙女喋喋不休的抱怨书，自然不可能撒下这个好评，
											  这里写下也给各位淘友一个参考，这个物品还是值得购买的。
											  ---来自一位懒惰的只爱购物不爱写评语却想换积分的仙女。 							
										</div>
										<div class="review-media">
											<ul>
												<li>
													<img src="img/details/item_5.jpg" />
												</li>
												<li>
													<img src="img/details/item_6.jpg" />
												</li>
												<li>
													<img src="img/details/item_7.jpg" />
												</li>
												<li>
													<img src="img/details/item_8.jpg" />
												</li>
												<li>
													<img src="img/details/item_9.jpg" />
												</li>
											</ul>
										</div>
										<div class="review-bar">
								...
								<li class="sec_main_first">
									...
									<div class="review-details">
										<div class="review-content">
											  ...
											  真怕不一个不小心就会扯坏，穿的时候小心翼翼，胸大的妹子不建议买，
											  衣服整体上身效果还是不错的，具体看图  							
										</div>
										<div class="review-media">
											<ul>
												<li>
													<img src="img/details/item_10.jpg" />
												</li>
								...
								<li class="sec_main_first">
									...
									<div class="review-details">
										<div class="review-content">
											  ...
											  买了的人一定不会后悔的！以前看到的时候就想买，结果一拖再拖，现在终于入手了，
											  特别特别漂亮，看到衣服有种很惊艳的感觉呢！  							
										</div>
										<div class="review-media">
											<ul>
												<li>
													<img src="img/details/item_11.jpg" />
												</li>
									...
									<div class="review-details_append">
										<div class="review-content">
											<span>[追加评论]</span>
											  原谅我忍不住出来放图，端午前一天拍的，后期是我，摄影是室友😏 							
										</div>
										<div class="review-media">
											<ul>
												<li>
													<img src="img/details/item_12.jpg" />
												</li>
												<li>
													<img src="img/details/item_13.jpg" />
												</li>
											</ul>
										</div>
										<div class="review-bar">
								...
								<li class="sec_main_first">
									...
									<div class="review-details">
										<div class="review-content">
											  ...
											  要小心点，穿着可能会感觉有点热，不过我这里本来也比较热，总之还
											  是很满意的，以后也会继续支持的。 							
										</div>							
										<div class="review-bar">
											<div class="review-bar-info">
								...
								<li class="sec_main_first">
									...
									<div class="review-details_append">
										...
										<div class="review-media">
											<ul>
												<li>
													<img src="img/details/item_14.jpg" />
												</li>
				...
				<div class="others">
					<div class="price-spec">
						...
						<p class="info">
							商家详情页（含主图）以图片或文字形式标注的一口价、促销价、优惠价等价格可能是在使用优惠券、
							满减或特定优惠活动和时段等情形下的价格，具体请以结算页面的标价、优惠条件或活动规则为准。
						</p>
							...
							<ul>
								<li>
									<div class="item">
										<div class="pic">
											<a class="side-item">
												<img src="img/details/still-look1.jpg" />
											</a>
										</div>
										<div class="desc">
								...
								<li>
									<div class="item">
										<div class="pic">
											<a class="side-item">
												<img src="img/details/still-look2.jpg" />
											</a>
										</div>
										<div class="desc">
								...
								<li>
									<div class="item">
										<div class="pic">
											<a class="side-item">
												<img src="img/details/still-look3.jpg" />
											</a>
										</div>
										<div class="desc">
								...
								<li>
									<div class="item">
										<div class="pic">
											<a class="side-item">
												<img src="img/details/still-look4.jpg" />
											</a>
										</div>
										<div class="desc">
								...
								<li>
									<div class="item">
										<div class="pic">
											<a class="side-item">
												<img src="img/details/still-look5.jpg" />
											</a>
										</div>
										<div class="desc">
						...
						<ul>
							<li>
								<div class="item">
									<div class="pic">
										<a class="side-item">
											<img src="img/details/still_buy1.jpg" />
										</a>
									</div>
									<div class="desc">
										<a class="side-item">文艺清新碎花雪纺连衣裙 复古chic森系仙</a>
							...
							<li>
								<div class="item">
									<div class="pic">
										<a class="side-item">
											<img src="img/details/still_buy2.jpg" />
										</a>
									</div>
									<div class="desc">
							...
							<li>
								<div class="item">
									<div class="pic">
										<a class="side-item">
											<img src="img/details/still_buy3.jpg" />
										</a>
									</div>
									<div class="desc">
							...
							<li>
								<div class="item">
									<div class="pic">
										<a class="side-item">
											<img src="img/details/still_buy4.jpg" />
										</a>
									</div>
									<div class="desc">
							...
							<li>
								<div class="item">
									<div class="pic">
										<a class="side-item">
											<img src="img/details/still_buy5.jpg" />
										</a>
									</div>
									<div class="desc">
